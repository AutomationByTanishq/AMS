<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
         import="java.sql.*,java.io.*,javax.servlet.*" pageEncoding="ISO-8859-1"%>
...
PreparedStatement pst2=con.prepareStatement("select * from workingdays where year=?");
        ...
        PreparedStatement pst1=con.prepareStatement("select count(*) from facultyattendance12 where id=? and log between ? and ?");
...
RequestDispatcher rd=request.getRequestDispatcher("./facultymonthattdetails.jsp");
